...
#define RF_IRQ_PIN    16    // RF module IRQ - moved from GPIO15 to avoid TFT_CS conflict
...
#if RF_IRQ_PIN == TFT_CS
#error "Pin conflict: RF_IRQ_PIN and TFT_CS cannot use the same GPIO"
#endif
